...
BooksAPI.search('Cycling').then(data => {console.log(data)})
        ...
        {this.state.showSearchPage ? (
          ...
          <div className="list-books">
            ...
            <div className="list-books-content">
              <div>
                <Shelf title="Currently Reading" books={booksCurrent}/>
                <Shelf title="Want to Read" books={booksWant}/>
                <Shelf title="Read" books={booksRead}/>
              </div>
            </div>
